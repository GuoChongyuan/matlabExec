...
trans_coordinate.x = -7.5 + 2.*trans_to_return_length_e.*rand() - trans_to_return_length_e;
trans_coordinate.y = 0;

%初始化接收机坐标
return_roordinate = struct();
return_roordinate.x = 7.5 + 2.*trans_to_return_length_e.*rand() - trans_to_return_length_e;
